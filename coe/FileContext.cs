...
namespace RN.FileManagers.NetCore
{
    public class FileContext
    {
        ...
        {
            if (Configuration.Instance.RootUrl.IndexOf("http") == -1)
            {
        ...
        private string GetResourceStreamString(string fileName)
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream(string.Format("RN.FileManagers.Core.data.{0}", fileName)))
